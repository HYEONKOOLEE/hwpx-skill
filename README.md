...
> **버전** v1.2.0 · **최종 수정** 2026-09-01
>
> **이 저장소 하나로 완결됩니다. 함께 설치해야 하는 다른 스킬은 없습니다.**
>
> **v1.2 변경점**: 스킬 범위를 **읽기·편집·생성·저장**으로 한정하고, 다른 스킬로 넘기는
> 분기 안내를 제거했습니다. v1.1까지는 `SKILL.md`가 누름틀 채우기 작업을 별도 스킬로
> 넘기라고 안내해, 설치한 분들이 "추가 설치가 필요한가?"로 오해하는 일이 있었습니다.
...
1. `dist/hwpx-v1.2.0.skill` 파일을 클로드 대화창에 올립니다
2. 나타나는 **저장** 버튼을 누릅니다
...
작성일: 2026-09-01 | 버전: v1.2.0 | 작성: 프랭크 × 에이미 협업
