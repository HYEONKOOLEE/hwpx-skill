...
> **버전** v1.1.0 · **최종 수정** 2026-08-29
>
> **v1.1 새 기능**: `.hwp`를 그대로 업로드해도 자동으로 `.hwpx`로 변환해 처리하고,
> 작업 후 올린 형식 그대로 되돌려줍니다(한컴오피스 불필요). 한글에서 "hwpx로 재저장"하는
> 수작업이 사라졌습니다. 자세한 내용은 `skills/hwpx/CHANGELOG.md` 참조.
...
1. `dist/hwpx-v1.1.0.skill` 파일을 클로드 대화창에 올립니다
2. 나타나는 **저장** 버튼을 누릅니다
